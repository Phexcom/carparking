...
<div class="form-group input-group-lg">
    ...
    <input name="name" class="form-control"  placeholder="Enter name" type="text" value="<?php echo set_value('name'); ?>" required="required" />
    <?php echo form_error('name','<div class="alert alert-danger text-center">','</div>'); ?>      
</div>

<div class="form-group input-group-lg">
    <label for="address" >Address:</label>
    <input name="address"  class="form-control" placeholder="Enter Address" type="text" value="<?php echo set_value('address'); ?>" required="required" />
    <?php echo form_error('address','<div class="alert alert-danger text-center">','</div>'); ?>      
</div>

<div class="form-group input-group-lg">
    <label for="card">Card:</label>
    <input name="card"  class="form-control" placeholder="Enter Card" type="text" value="<?php echo set_value('card'); ?>"  required="required"/>
    <?php echo form_error('card','<div class="alert alert-danger text-center">','</div>'); ?>      
</div>

<div class="form-group input-group-lg">
    <label for="email" >Email:</label>
    <input name="email"  class="form-control" placeholder="Enter Email" type="email" value="<?php echo set_value('email'); ?>"  required="required" />
...
<div class="form-group input-group-lg">
    ...
    <input name="password_confirm"  class="form-control" placeholder="Confirm Password" type="password"  required="required" />
